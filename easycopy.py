...
text ='''自然語言處理: 是人工智能和語言學領域的分支學科。
            在這此領域中探討如何處理及運用自然語言；自然語言認知則是指讓電腦“懂”人類的語言。
            自然語言生成係統把計算機數據轉化為自然語言。自然語言理解係統把自然語言轉化為計算機程序更易於處理的形式。'''  #將爬取該看板的所有標題組成一串句子丟進去
s = ' '.join(jieba.cut(text)) #句子切割

font = 'NotoSansCJKtc-Regular.otf' #由於是中文，所以要載字型，我有包給你

# Mask image 有特定圖片才需以下註解的這幾行
# '''
mask_color = np.array(Image.open('300.jpg')) #('')中要放圖片
